...
# LOW-LEVEL POLYFILL FOR PYTHON < 3.11
...
app.state.config.PIPECAT_ENABLED = PIPECAT_ENABLED
app.state.config.PIPECAT_API_URL = PIPECAT_API_URL
app.state.config.PIPECAT_CONNECTION_MODE = PIPECAT_CONNECTION_MODE
        ...
        **(
            {
                ...
                "audio": {
                    ...
                    "pipecat": {
                        "enabled": app.state.config.PIPECAT_ENABLED,
                        "url": app.state.config.PIPECAT_API_URL,
                        "connection_mode": app.state.config.PIPECAT_CONNECTION_MODE,
                    },
                },
                "file": {
